...
public class ZeppelinSetInterpreterPermission {
    public static void main(String[] args) throws IOException {
        ...
        //;jdbcList.add("jdbcSource31");jdbcList.add("jdbcSource30");jdbcList.add("jdbcSource94");jdbcList.add("jdbcSource33");jdbcList.add("jdbcSource293");
        //山证科技
        ...
        jdbcList.add("jdbcSource293");jdbcList.add("jdbcSource168");jdbcList.add("jdbcSource302");jdbcList.add("jdbcSource135");
        //固收
        //jdbcList.add("jdbcSource30");

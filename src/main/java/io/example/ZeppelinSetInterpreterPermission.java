...
public class ZeppelinSetInterpreterPermission {
    public static void main(String[] args) throws IOException {
        ...
        //资管投研
        //jdbcList.add("jdbcSource19");jdbcList.add("jdbcSource20");jdbcList.add("jdbcSource50");jdbcList.add("jdbcSource23");jdbcList.add("jdbcSource28");jdbcList.add("jdbcSource31");jdbcList.add("jdbcSource30");
        //山证科技

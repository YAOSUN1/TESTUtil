...
public class ZeppelinSetInterpreterPermission {
    public static void main(String[] args) throws IOException {
        ...
        jdbcList.add("jdbcSource19");jdbcList.add("jdbcSource20");jdbcList.add("jdbcSource50");jdbcList.add("jdbcSource23");jdbcList.add("jdbcSource28");jdbcList.add("jdbcSource31");
        ...
        //userList.add("wengran");userList.add("tanrui");userList.add("jiansijie");userList.add("chenleiyu");userList.add("taoxiaoshan");
